...
export default function DashboardView() {
    ...
    if (data && user) return (
        <>
            <h1 className="text-4xl font-black uppercase">Mis Proyectos</h1>
            <p className="text-xl font-light text-gray-600 mt-3">Maneja y administra tus proyecto</p>
            <nav className="my-5">
                <Link
                    to={'/projects/create'}
            ...
            {data.length ? (
                <>
                    <ul role="list" className="divide-y divide-gray-100 border border-gray-100 mt-10 bg-white shadow-lg">
                        {data.map((project) => (
                            <li key={project._id} className="flex justify-between gap-x-6 p-5">
